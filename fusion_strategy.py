...
# addition fusion strategy（添加策略）
def addition_fusion(tensor1, tensor2):
    return (tensor1 + tensor2)/2


# attention fusion strategy, average based on weight maps（注意力融合策略，基于权重图的平均值）
...
def spatial_fusion(tensor1, tensor2, spatial_type='sum'):
    ...
    # get weight map, soft-max，权重求解，这块看着像是泰勒展开逼近？
